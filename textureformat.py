...
class BlockTextureFormat(TextureFormat):
    ...
    """
    def __init__(self, img: bytes, width: int, height: int, size: int):
...
class PVRFormat(TextureFormat, Enum):
    ...
    """
    PVRTC1_4 = (bytes([0x00, 0x00, 0x00, 0x00]))
...
class DDSFormat(BlockTextureFormat, Enum):
    ...
    BC2 = (bytes([0x00, 0x07, 0x00, 0x01]), bytes([0x44, 0x58, 0x54, 0x33, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]), 16, True) # DXT3
    ...
    def __init__(self, img: bytes, dxt: bytes, size: int, compressed: bool):
...
class TEX0Format(BlockTextureFormat, Enum):
    ...
    def __init__(self, img: bytes, tex0: bytes, width: int, height: int, size: int):
